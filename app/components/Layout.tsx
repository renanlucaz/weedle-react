            ...
            <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
                ...
                <nav className="mt-8 px-4 pb-4 overflow-y-auto h-[calc(100vh-120px)]">
                    <div className="space-y-2">
                        {/* Dashboard - Link direto para rota raiz */}
                        <Link
                            to="/"
                            onClick={() => setMobileMenuOpen(false)}
                        ...
                        <Link
                            ...
                            onClick={() => setMobileMenuOpen(false)}
                            className={`flex items-center px-4 py-3 rounded-lg transition-colors ${isActive("/dashboard/clientes")
                                ? "text-white bg-purple-500"
                                : "text-gray-600 hover:bg-gray-100"
                                }`}
                        >
                        ...
                        <Link
                            to="/dashboard/nps"
                            onClick={() => setMobileMenuOpen(false)}
                            className={`flex items-center px-4 py-3 rounded-lg transition-colors ${isActive("/dashboard/nps")
                                ? "text-white bg-purple-500"
                                : "text-gray-600 hover:bg-gray-100"
                                }`}
                        >
                        ...
                        <Link
                            ...
                            onClick={() => setMobileMenuOpen(false)}
                            className={`flex items-center px-4 py-3 rounded-lg transition-colors ${isActive("/dashboard/contratos")
                                ? "text-white bg-purple-500"
                                : "text-gray-600 hover:bg-gray-100"
                                }`}
                        >
